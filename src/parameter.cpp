...
const float parameter::ideal_photo[2][5] = { { /*130*/ 14, /*200*/ -12, 0, 0, -7/*中心からどれだけオフセットがあるか[mm]*/ },
		{ 3250, 3200, 10815, 10100, 0 } };
const int16_t parameter::min_wall_photo[2][5] = { { 15, 60, 1400, 130, 300 }, {
		20000, 20000, 0, 0, 0 } };
...
const std::array<INIT_SLALOM, 1> right_begin45_half = { {
		{ 0.5, 46, 20, 0.013, 0.029, 195.0775, 11.67003, 0 },
} };
const std::array<INIT_SLALOM, 1> left_begin45_half = { {
		{ 0.5, 45, 20, 0.011, 0.033, 195.0775, 11.67003, 0 },
} };

//出の45°ターン
const std::array<INIT_SLALOM, 1> right_end45_half = { {
		{ 0.5, 45.8, 20, 0.035, 0.012, 195.0775, 11.67003, 0 },
} };
...
const std::array<INIT_SLALOM, 1> right_begin135_half = { {
		{ 0.5, 135, 45, 0.020, 0.025, 141.1387, 14.89, 0 },
} };
const std::array<INIT_SLALOM, 1> left_begin135_half = { {
		{ 0.5, 137, 45, 0.025, 0.025, 141.1387, 14.89, 0 },
} };

//出の135°ターン
const std::array<INIT_SLALOM, 1> right_end135_half = { {
		{ 0.5, 136, 45, 0.016, 0.030, 141.1387, 14.89, 0 },
} };
const std::array<INIT_SLALOM, 1> left_end135_half = { {
		{ 0.5, 134.8, 45, 0.016, 0.031, 141.1387, 14.89, 0 },
} };

//ななめ90°ターン
const std::array<INIT_SLALOM, 1> right_obli90_half = { {
		{ 0.5, 90, 40, 0.003, 0.008, 162.5137, 15.0636, 0 },
} };
