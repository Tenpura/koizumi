...
const float parameter::ideal_photo[2][5] = { { /*130*/ 14, /*200*/ -9.5, 0, 0, -5/*中心からどれだけオフセットがあるか[mm]*/ },
...
const std::array<INIT_SLALOM, 2> right_small_half = { {
		{ SEARCH_VELOCITY, 90.8, 30, 0.012, 0.007, 119.1789, 11.17156, 0 },
...
const std::array<INIT_SLALOM, 1> right_end45_half = { {
		{ 0.5, 45.8, 20, 0.033, 0.01, 195.0775, 11.67003, 0 },
} };
const std::array<INIT_SLALOM, 1> left_end45_half = { {
		{ 0.5, 45, 20, 0.026, 0.016, 195.0775, 11.67003, 0 },
} };
...
const std::array<INIT_SLALOM, 1> right_end135_half = { {
		{ 0.5, 136, 45, 0.012, 0.036, 141.1387, 14.89, 0 },
} };
const std::array<INIT_SLALOM, 1> left_end135_half = { {
		{ 0.5, 135, 45, 0.016, 0.031, 141.1387, 14.89, 0 },
} };
